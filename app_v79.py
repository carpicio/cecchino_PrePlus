...
# --- CONFIGURAZIONE ---
st.set_page_config(page_title="Sniper V79 - Excel & CSV", page_icon="📂", layout="wide")
st.title("📂 Sniper Bet V79 (Universal Reader)")
st.markdown("""
**Supporto Totale:** Ora puoi caricare sia file **CSV** che **Excel (.xlsx, .xls)**.
Il sistema riconosce automaticamente il formato e applica le strategie.
""")
st.markdown("---")
...
def load_data(file, hfa, dyn, s1, s2):
    try:
        ...
        # --- 1. RICONOSCIMENTO FORMATO (CSV vs EXCEL) ---
        ...
        ren = {
            ...
            # Supporto per il formato "Place 1"
...
# --- MAIN APP ---
# Aggiornato per accettare multipli formati
